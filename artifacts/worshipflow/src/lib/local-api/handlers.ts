...
const DEFAULT_SCREEN_STATE: Record<string, unknown> = {
  ...
  scoreboardBgColor: "rgba(10,10,20,0.88)",
  scoreboardAccentA: "#ef4444",
  scoreboardAccentB: "#3b82f6",
  urlOverlayEnabled: false,
  urlOverlayUrl: "",
  urlOverlayPosition: "top-right",
  urlOverlayWidth: 32,
  urlOverlayHeight: 22,
  urlOverlayOpacity: 100,
