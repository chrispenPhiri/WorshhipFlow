...
- **How To** (`/how-to`) — In-app user guide. Searchable accordion covering every feature (Bible, Songs, Custom Text, Themes, Media & Broadcast, Schedule, Sermon Notes, Daily Inspiration, Settings, Live Preview Sidebar) with quick-jump tiles at the top, numbered steps, pro tips, and an "Open page" link per section. Open-state persists via `wf-howto-open`.
